...
const skills = [
    ...
    },
    {
        ...
        name: "Сильный довод", 
        icon: "🔥",
        description: "Мощное убеждение с высоким уроном",
        power: 30,
        enduranceCost: 15,
        successChance: 0.45,
        level: 1,
    ...
    },
    {
        ...
        icon: "❤️",
        description: "Апелляция к чувствам клиента",
        power: 25,
        enduranceCost: 12,
        successChance: 0.60,
        level: 1,
    ...
    },
    {
        ...
        icon: "🔗",
        description: "Построение логических аргументов",
        power: 22,
        enduranceCost: 11,
        successChance: 0.65,
        level: 1,
    ...
    },
    {
        ...
        icon: "⏰",
        description: "Создание срочности",
        power: 35,
        enduranceCost: 18,
        successChance: 0.40,
        level: 1,
    ...
    },
    {
        ...
        icon: "💰",
        description: "Предложение специальных условий",
        power: 40,
        enduranceCost: 20,
        successChance: 0.35,
        level: 1,
